...
// @todo : adpat with cfp enfity name.
...
class UserShopRegisterForm extends FormBase {
  ...
  /*public static function create(ContainerInterface $container, ElementInfoManagerInterface $elementInfoManager) {
    return new static($container->get('current_user'));
  }*/

  /**
   * Initialize the inner form objects : parts of the form. User and information_commerce are entities.
   *
   * @todo.
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($this->innerForms as $key => $inner_form_object) {
      ...
      //$form[$key]['form']['#theme_wrappers'] = $this->elementInfoManager->getInfoProperty('container', '#theme_wrappers', []);
